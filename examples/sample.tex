...
\title{A sample document for \texttt{Epsilon}\thanks{This file exercises most supported features.}}
...
\begin{abstract}
We collect the constructs that \texttt{Epsilon} converts: numbered equations and
...
\end{quote}
\begin{verbatim}
python3 epsilon_convert.py sample.tex
\end{verbatim}
